...
class StuQuizsummary extends StatefulWidget {
  final String userId;

  const StuQuizsummary({super.key, required this.userId});

  @override
  State<StuQuizsummary> createState() => _StuQuizsummaryState();
}

class _StuQuizsummaryState extends State<StuQuizsummary> {
      ...
      if (userId.isEmpty) {
        try {
          final profileResponse = await http.get(
            Uri.parse("http://localhost:8000/student/profile/"),
            headers: {
